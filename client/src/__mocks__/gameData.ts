...
export const mockPlayers: Player[] = [
  ...
  },
  {
    ...
    meansCards: [
      { id: 'M001', name: '刀' }, { id: 'M005', name: '斧头' },
      { id: 'M006', name: '锤子' }, { id: 'M007', name: '枕头' },
    ],
    clueCards: [
      { id: 'C001', name: '血迹' }, { id: 'C005', name: '纽扣' },
      { id: 'C006', name: '布料碎片' }, { id: 'C007', name: '手套' },
    ],
  },
  {
    ...
    meansCards: [
      { id: 'M008', name: '针筒' }, { id: 'M009', name: '电击器' },
      { id: 'M010', name: '剪刀' }, { id: 'M011', name: '砖块' },
    ],
    clueCards: [
      { id: 'C008', name: '头发' }, { id: 'C009', name: '口红印' },
      { id: 'C010', name: '钥匙' }, { id: 'C011', name: '手机' },
    ],
  },
  {
    ...
    meansCards: [
      { id: 'M012', name: '铁管' }, { id: 'M013', name: '棒球棍' },
      { id: 'M014', name: '石头' }, { id: 'M015', name: '玻璃碎片' },
    ],
    clueCards: [
      { id: 'C012', name: '照片' }, { id: 'C013', name: '信件' },
      { id: 'C014', name: '日记本' }, { id: 'C015', name: '处方签' },
    ],
  },
  {
    ...
    role: 'detective', status: 'alive', hasSolveRight: true,
    meansCards: [
      { id: 'M016', name: '螺丝刀' }, { id: 'M017', name: '扳手' },
      { id: 'M018', name: '钢琴线' }, { id: 'M019', name: '弓箭' },
    ],
    clueCards: [
      { id: 'C016', name: '车票' }, { id: 'C017', name: '收据' },
      { id: 'C018', name: '名片' }, { id: 'C019', name: '门卡' },
    ],
  },
  {
    ...
    meansCards: [
      { id: 'M020', name: '高尔夫球杆' }, { id: 'M021', name: '花瓶' },
      { id: 'M022', name: '灭火器' }, { id: 'M023', name: '平底锅' },
    ],
    clueCards: [
      { id: 'C020', name: '香水味' }, { id: 'C021', name: '汗味' },
      { id: 'C022', name: '泥土' }, { id: 'C023', name: '花粉' },
    ],
  },
  {
    ...
    meansCards: [
      { id: 'M024', name: '菜刀' }, { id: 'M025', name: '冰锥' },
      { id: 'M026', name: '电锯' }, { id: 'M027', name: '铁链' },
    ],
    clueCards: [
      { id: 'C024', name: '火柴' }, { id: 'C025', name: '打火机' },
      { id: 'C026', name: '蜡烛' }, { id: 'C027', name: '纸巾' },
    ],
  },
]
